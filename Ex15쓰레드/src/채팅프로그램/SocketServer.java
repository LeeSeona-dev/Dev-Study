...
//서버 소켓 쪽에서 해야할 일 정의 (주체가 서버)
//1. 사용자가(클라이언트)가 입력한 채팅 받는것
//2. 받은 채팅을 다른 사용자들(클라이언트)한테도 보내주는 것
public class SocketServer extends Thread{
	...
	public void run() {
		...
		//클라이언트가 접속하면 해당 클라이언트 PC ip 주소를 출력
