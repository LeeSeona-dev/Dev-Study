...
public class Controller {
	...
	int index = 0; //전역변수 : 모든 메서드들이 공유해서 사용
...
//		musicList.add(m);
		// / :  폴더안에 들어감
		musicList.add(new Model("attention","뉴진스",50,"music/attention.mp3"));
		...
		musicList.add(new Model("OMG","뉴진스",100,"music/OMG.mp3"));
	}
	...
	public void next() {
		...
		if(index < musicList.size()-1) { //index 0~3(4보다 작을때
			index++; //인덱스 1증가
		}else { //index==4
			index = 0;
		}
